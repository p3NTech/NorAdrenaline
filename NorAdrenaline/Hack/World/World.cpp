	...
	if (pLocal && pLocal->player)
	{
		...
		//Get Distance to Ground
		{
			...
			//Get Distance to Player under me
			{
				...
				{
					g_Local.flHeightGround = abs(PlayerTrace.endpos.z - pmove->origin.z);
